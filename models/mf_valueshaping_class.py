...
class MFValueShapingAgent:
    ...
    def initialize_start_position(self):
        ...
        exp = "baseline" if self.learning_mode == self.TRAINING else self.world_model
    ...
    def get_rewards_for_episode(self, episode):
        ...
        if self.world_model == "exp2" and self.learning_mode == self.TEST:
    ...
    def run_full_simulation(self):
        ...
        for episode in range(self.n_episodes):
            ...
            self.learning_mode = (
                self.TRAINING if episode < self.n_episodes * self.training_split else self.TEST
            )
            ...
            self.log['steps_to_reward'][episode] = step + 1
        ...
        self.log['values'] = np.copy(self.Q)  
        return self.log
